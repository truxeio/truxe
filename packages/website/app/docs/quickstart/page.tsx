      ...
      <main className="container-custom max-w-4xl space-y-12 py-16">
        <section className="space-y-6 text-center">
          ...
          <p className="text-lg text-muted mx-auto max-w-2xl">
            Complete installation and setup documentation is coming soon. Join the waitlist to get notified when it's ready.
          </p>
        </section>
        ...
        <section className="card bg-gradient-to-br from-primary/5 to-primary/10 p-12 text-center space-y-6">
          ...
          <p className="text-muted max-w-2xl mx-auto">
            We're working on comprehensive quickstart documentation that will help you get up and running with Truxe in under 10 minutes. This guide will include Docker setup, environment configuration, and your first authentication flow.
          </p>
          <Link
            href="/#waitlist"
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Link href="/docs/sdk" className="card bg-white p-6 shadow-soft hover:shadow-lg transition-all group">
              ...
              <p className="text-sm text-muted">
                Official SDKs for easier integration
              </p>
            </Link>
